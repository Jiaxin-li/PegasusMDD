...
public class ScheduleAdapterFactory extends AdapterFactoryImpl {
	...
	protected ScheduleSwitch<Adapter> modelSwitch =
		new ScheduleSwitch<Adapter>() {
			@Override
			public Adapter caseAvailablityMap(AvailablityMap object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link RootElement.Schedule.AvailablityMap <em>Availablity Map</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAvailablityMapAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link RootElement.Schedule.RoomSchedule <em>Room Schedule</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRoomScheduleAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link RootElement.Schedule.ISchedule <em>ISchedule</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createIScheduleAdapter() {
		return null;
	}
