...
public interface PaymentPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int IPAYMENT___INITIATE_PAYMENT = 0;
	...
	/**
	 * Returns the meta object for the '{@link RootElement.Payment.IPayment#initiatePayment() <em>Initiate Payment</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EOperation getIPayment__InitiatePayment();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EOperation IPAYMENT___INITIATE_PAYMENT = eINSTANCE.getIPayment__InitiatePayment();
