...
public class TaskSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TaskPackage.TASK_MANAGEMENT: {
				TaskManagement taskManagement = (TaskManagement)theEObject;
				T result = caseTaskManagement(taskManagement);
	 ...
	 * @generated
	 */
	public T caseTaskManagement(TaskManagement object) {
		return null;
	}
