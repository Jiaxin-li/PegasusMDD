/**
 */
package RootElement.Booking.util;
...
public class BookingAdapterFactory extends AdapterFactoryImpl {
	...
	protected BookingSwitch<Adapter> modelSwitch =
		new BookingSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCartManagement(CartManagement object) {
				return createCartManagementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link RootElement.Booking.Cart <em>Cart</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link RootElement.Booking.Booking <em>Booking</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link RootElement.Booking.IBooking <em>IBooking</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link RootElement.Booking.CartManagement <em>Cart Management</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCartManagementAdapter() {
		return null;
	}
