...
public class ServiceFactoryImpl extends EFactoryImpl implements ServiceFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ServicePackage.SERVICE_TYPE: return createServiceType();
			case ServicePackage.SERVICE_MANAGEMENT: return createServiceManagement();
			case ServicePackage.SERVICE_TYPE_MANAGMENT: return createServiceTypeManagment();
			default:
	 ...
	 * @generated
	 */
	public ServiceTypeManagment createServiceTypeManagment() {
		ServiceTypeManagmentImpl serviceTypeManagment = new ServiceTypeManagmentImpl();
		return serviceTypeManagment;
	}
